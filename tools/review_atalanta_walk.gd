extends SceneTree
const NORTH = preload("res://themes/atalanta_north_walk.tres")
const SOUTH = preload("res://themes/atalanta_south_walk.tres")
...
func run() -> void:
	...
	print("Atalanta north/south native walking study completed")
	quit()
