extends SceneTree
const South = preload("res://themes/hoplite_south_defeat.tres")
const North = preload("res://themes/hoplite_south_defeat.tres")
...
func run():
	...
	var actors: Array=[]
	var rests=[preload("res://themes/hoplite_south_rest.tres"),preload("res://themes/hoplite_south_rest.tres"),preload("res://themes/hoplite_south_rest.tres"),preload("res://themes/hoplite_south_rest.tres")]
	for i in 4:
	...
	print("Hoplite south defeat study: canonical south rest / two south defeats / canonical south rest; 90 native frames.")
	quit(0)
