...
if ($Graphics) {
    foreach ($test in @("test_sprite_clip", "test_board", "test_app", "test_controls", "test_ninth_gate_board", "test_ninth_gate_app", "test_olympus_combat_fx", "test_olympus_board", "test_olympus_stage", "test_olympus_models", "test_olympus_creatures", "test_olympus_app")) {
