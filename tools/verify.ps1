...
foreach ($test in @("test_sprite_clip", "test_bridge_flow", "test_chess", "test_chess_oracle", "test_session", "test_draw_claims", "test_pgn", "test_olympus_audio", "test_olympus_hud_fx")) {
