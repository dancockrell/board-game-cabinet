...
if ($Graphics) {
    foreach ($test in @("test_sprite_clip", "test_pixel_motion_continuity", "test_hydra_lateral", "test_hydra_south_walk", "test_hydra_north_walk", "test_atalanta_lateral_walk", "test_olympus_combat_fx", "test_olympus_board", "test_olympus_stage", "test_olympus_models", "test_olympus_app", "test_olympus_2d_only")) {
