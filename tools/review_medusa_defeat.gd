extends SceneTree
const South = preload("res://themes/medusa_south_defeat.tres")
const North = preload("res://themes/medusa_north_defeat.tres")
...
func run():
	...
	var actors: Array=[]
	var rests=[preload("res://themes/medusa_south_rest.tres"),preload("res://themes/medusa_south_rest.tres"),preload("res://themes/medusa_north_rest.tres"),preload("res://themes/medusa_north_rest.tres")]
	for i in 4:
	...
	print("Medusa defeat study: canonical south rest / south defeat / north defeat / canonical north rest; 90 native frames.")
	quit(0)
