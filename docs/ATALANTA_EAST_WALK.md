...
The east walk now contains eight individually generated phase drawings: contact, weight transfer, passing, extension, then those four phases with opposite leg support. These are eight authored images, not repeated timings or a mirrored four-frame clip. West remains four phases.
...
Remaining art work: lighten the excessive far-leg shadow without losing layer identity; add arm and braid counter-motion; improve transition cadence and author the west equivalent. Eight poses are a useful increase, not a claim of finished animation quality. The shadow currently can read as a stocking. The corrected down pose has restrained compression rather than the initial pronounced crouch.
