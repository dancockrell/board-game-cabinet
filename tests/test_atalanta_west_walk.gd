...
const REST = preload("res://themes/atalanta_west_rest.tres")
const ATTACK = preload("res://themes/atalanta_west_attack.tres")
...
func _initialize() -> void:
	...
	check(seen.size() == 8, "No repeated atlas fills the eight-source cycle")
	actor.show_time(elapsed + .001)
	...
	actor.free()
	print("Atalanta west walk checks: ", checks, "; failures: ", failures)
