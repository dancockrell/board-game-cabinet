...
const HYDRA_WALK = {"south":preload("res://themes/hydra_south_walk.tres"),"east":preload("res://themes/hydra_east_walk.tres"),"west":preload("res://themes/hydra_west_walk.tres")}
