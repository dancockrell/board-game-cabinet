...
const HERACLES_WALK = {"east":preload("res://themes/heracles_east_walk.tres"),"north":preload("res://themes/heracles_north_walk.tres"),"south":preload("res://themes/heracles_south_walk.tres")}
