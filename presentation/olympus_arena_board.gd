...
const HERACLES_WALK = {"west":preload("res://themes/heracles_west_walk.tres"),"east":preload("res://themes/heracles_east_walk.tres"),"north":preload("res://themes/heracles_north_walk.tres"),"south":preload("res://themes/heracles_south_walk.tres")}
const ATALANTA_WALK = {"east":preload("res://themes/atalanta_east_walk.tres"),"west":preload("res://themes/atalanta_west_walk.tres"),"north":preload("res://themes/atalanta_north_walk.tres"),"south":preload("res://themes/atalanta_south_walk.tres")}
const HYDRA_WALK = {"north":preload("res://themes/hydra_north_walk.tres"),"south":preload("res://themes/hydra_south_walk.tres"),"east":preload("res://themes/hydra_east_walk.tres"),"west":preload("res://themes/hydra_west_walk.tres")}
